...
extern "C" {
    pub fn ksceKernelSetupForModulemgr();
}
extern "C" {
...
extern "C" {
    pub fn ksceKernelGetModuleList2(
        pid: SceUID,
...
extern "C" {
    pub fn ksceKernelGetModuleInternal(
        modid: SceUID,
        info: *mut *mut crate::ctypes::c_void,
    ) -> crate::ctypes::c_int;
}
extern "C" {
    pub fn ksceKernelGetModuleIdByAddr(
        pid: SceUID,
        module_addr: *const crate::ctypes::c_void,
    ) -> SceUID;
}
...
extern "C" {
    pub fn ksceKernelGetProcessMainModule(pid: SceUID) -> SceUID;
}
extern "C" {
...
extern "C" {
    pub fn ksceKernelGetModuleLibraryInfo(
        pid: SceUID,
        library_id: SceUID,
...
pub struct SceKernelModuleExportEntry {
    pub libnid: u32,
    pub entry: *const crate::ctypes::c_void,
}
extern "C" {
    pub fn ksceKernelGetModuleLibExportList(
        pid: SceUID,
        library_id: SceUID,
...
extern "C" {
    pub fn ksceKernelGetModuleListByImport(
        pid: SceUID,
        library_id: SceUID,
        modids: *mut SceUID,
        num: *mut SceSize,
...
extern "C" {
    pub fn ksceKernelGetProcessLibraryIdList(
        pid: SceUID,
