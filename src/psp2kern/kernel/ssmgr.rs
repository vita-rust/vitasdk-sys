...
#[repr(C)]
pub struct SceConsoleId__bindgen_ty_1 {
    pub __bindgen_anon_1: __BindgenUnionField<SceConsoleId__bindgen_ty_1__bindgen_ty_1>,
    pub chassis_check: __BindgenUnionField<u8>,
