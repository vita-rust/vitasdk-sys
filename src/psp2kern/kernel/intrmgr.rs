...
extern "C" {
    pub fn ksceKernelMaskIntr(intr_code: crate::ctypes::c_int) -> crate::ctypes::c_int;
}
extern "C" {
    pub fn ksceKernelUnmaskIntr(intr_code: crate::ctypes::c_int) -> crate::ctypes::c_int;
}
extern "C" {
    pub fn ksceKernelSetIntrMasked(
        intr_code: crate::ctypes::c_int,
        masked: crate::ctypes::c_int,
    ) -> crate::ctypes::c_int;
}
extern "C" {
    pub fn ksceKernelGetIntrMasked(
        intr_code: crate::ctypes::c_int,
        masked: *mut crate::ctypes::c_int,
    ) -> crate::ctypes::c_int;
}
extern "C" {
