...
extern "C" {
    pub fn _sceAppMgrSaveDataDataSave(data: *mut SceAppMgrSaveDataData) -> crate::ctypes::c_int;
}
extern "C" {
    pub fn _sceAppMgrSaveDataDataRemove(
        data: *mut SceAppMgrSaveDataDataDelete,
    ) -> crate::ctypes::c_int;
}
extern "C" {
    pub fn _sceAppMgrSaveDataSlotCreate(data: *mut SceAppMgrSaveDataSlot) -> crate::ctypes::c_int;
}
extern "C" {
    pub fn _sceAppMgrSaveDataSlotGetParam(data: *mut SceAppMgrSaveDataSlot)
        -> crate::ctypes::c_int;
}
extern "C" {
    pub fn _sceAppMgrSaveDataSlotSetParam(data: *mut SceAppMgrSaveDataSlot)
        -> crate::ctypes::c_int;
}
extern "C" {
    pub fn _sceAppMgrSaveDataSlotDelete(
...
extern "C" {
    pub fn sceAppMgrDestroyAppByAppId(appId: SceUID) -> crate::ctypes::c_int;
}
extern "C" {
    pub fn sceAppMgrGetProcessIdByAppIdForShell(appId: SceUID) -> SceUID;
}
extern "C" {
...
extern "C" {
    pub fn sceAppMgrGetRawPath(
        path: *mut crate::ctypes::c_char,
        mount_point: *mut crate::ctypes::c_char,
        unk: *mut crate::ctypes::c_char,
    ) -> crate::ctypes::c_int;
}
extern "C" {
    pub fn _sceAppMgrGetRawPath(
        path: *mut crate::ctypes::c_char,
...
extern "C" {
    pub fn _sceAppMgrGetRawPathOfApp0ByAppIdForShell(
...
extern "C" {
    pub fn _sceAppMgrGetCoredumpStateForShell(
